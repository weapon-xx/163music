 ...
 * @return {Promise}
 */
export const requestUserPlaylist = promiseCache(uid => axios.get(`${domain}/user/playlist?uid=${uid}`).then(data => data.data), uid => `userPlaylist-${uid}`);
 ...
 * @return {Promise}
 */
export const requestUserDetail = promiseCache(uid => axios.get(`${domain}/user/detail?uid=${uid}`).then(data => data.data), uid => `userDetail-${uid}`);
 ...
 * @return {Promise}
 */
export const requestSuggestKeyword = promiseCache(keywords => axios.get(`${domain}/search/suggest?keywords=${keywords}`).then(data => data.data), keywords => `Suggest-${keywords}`);
 ...
 * @return {Promise}
 */
export const requestSearchByKeyword = promiseCache(keywords => axios.get(`${domain}/search?keywords= ${keywords}`).then(data => data.data), keywords => `Search-${keywords}`);
